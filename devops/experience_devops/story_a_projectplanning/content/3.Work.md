...
1.	Select the Area `HealthClinic\Cordova Team\Android`.
    ...
    > A Product Backlog Item is a Work Item with a particular field definition.

    > This fields allow us to introduce more important data about the Product Backlog Item, like the area, description, acceptance criteria and more.
...
1.	Double click the new item created, and modify the fields as desired.
    ...
    > These estimations are important as it will show us dashboards and panels for our planning.

    ![](img/image26.jpg)

1.	Select one of the Product Backlog Items and Drag & Drop before or below any order PBI to reorder according to their priority.	
...
1.	Click on the upper right graphic where the dates of the sprint are shown.	
    ...
    > We have available the Burndown chart for the sprint.
